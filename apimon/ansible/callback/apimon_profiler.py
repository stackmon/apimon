...
class CallbackModule(CallbackBase):
    ...
    ACTION_SERVICE_MAP = {
        ...
        'openstack.cloud.image': 'image',
        'openstack.cloud.image_info': 'image',
        'openstack.cloud.server': 'compute',
        'openstack.cloud.server_info': 'compute',
        'openstack.cloud.server_action': 'compute',
        'openstack.cloud.server_volume': 'compute',
        'openstack.cloud.server_metadata': 'compute',
        'openstack.cloud.router': 'network',
        'openstack.cloud.router_info': 'network',
        'openstack.cloud.network': 'network',
        'openstack.cloud.network_info': 'network',
        'openstack.cloud.subnet': 'network',
        'openstack.cloud.subnet_info': 'network',
        'openstack.cloud.security_group': 'network',
        'openstack.cloud.security_group_info': 'network',
        'openstack.cloud.security_group_rule': 'network',
        'openstack.cloud.volume': 'block_storage',
        'openstack.cloud.volume_info': 'block_storage',
        'openstack.cloud.volume_snapshot': 'block_storage',
        'openstack.cloud.volume_snapshot_info': 'block_storage',
        'openstack.cloud.volume_backup': 'block_storage',
        'openstack.cloud.volume_backup_info': 'block_storage',
